...
public class TerminoUI
{
    private TerminoTheme _theme = new();
    private TerminoMenu? _currentMenu;

    // Theme
    public void SetTheme(TerminoTheme theme) =>
        _theme = theme;

    public void ResetTheme() =>
        _theme = new TerminoTheme();

    // Menu Printing
    public void PrintMenu(TerminoMenu menu)
    {
        SetCurrentMenu(menu);
    ...
    public void ClearMenu(bool restoreCurrentCursorPosition = false)
    {
        if (_currentMenu is null)
            throw new Exception("Unable to clear current menu because it was not provided.");
    ...
    // User Input
    public TerminoMenuOption ReadUserInput()
    {
    ...
    public void PrintTokens(params TerminoTextToken[] tokens)
    {
        SetCursor();
    ...
    public void PrintTokensLine(params TerminoTextToken[] tokens)
    {
        PrintTokens(tokens);
        PrintLine();
    }
    ...
    // Private methods
    private void SetCurrentMenu(TerminoMenu menu)
    {
    ...
    private void AddDefaultOptions()
    {
        ...
        if (_theme.MenuTheme.AddExitOption)
            _currentMenu.Options.Add(new TerminoMenuOption("Exit"));
    }
    ...
    private void PrintOption(TerminoMenuOption option)
    {
        PrintLeftMargin();
